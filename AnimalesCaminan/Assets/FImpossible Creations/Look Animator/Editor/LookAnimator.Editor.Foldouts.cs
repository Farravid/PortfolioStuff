...
namespace FIMSpace.FLook
{
    public partial class FLookAnimator_Editor
    {
        ...
        private void Fold_DrawBackBones()
        {
            ...
            if (GUILayout.Button(new GUIContent(FGUI_Resources.GetFoldSimbol(drawBackBones, 10, "►") + "  Additional Spine Bones: (" + Get.BackBonesCount + ")", _TexBackbonesIcon, "Adding more neck/spine bones to look animation chain, using this feature can give you much more natural looking effects!"), FGUI_Resources.FoldStyle)) drawBackBones = !drawBackBones;

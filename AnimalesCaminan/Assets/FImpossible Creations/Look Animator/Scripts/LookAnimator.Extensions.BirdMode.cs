    ...
    public partial class FLookAnimator
    {
        ...
        private void CalculateBirdMode()
        {
            ...
            if (DelayPosition > 0f)
            {
                ...
                {
                    LookBones[i].animatedDelayPosition = Vector3.Lerp(LookBones[i].animatedDelayPosition, LookBones[i].targetDelayPosition, Time.deltaTime * Mathf.Lerp(5f, 30f, DelayGoSpeed));

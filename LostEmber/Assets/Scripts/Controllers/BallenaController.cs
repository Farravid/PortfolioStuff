...
public class BallenaController : MonoBehaviour
{
    #region Variables
    //Entradas
    ...
    //Referencia a la camara de cada controller para iniciarla cuando se inicie el script
    [SerializeField] private CinemachineVirtualCamera camaraAnimalPropia;
    ...
    public void PlayerInput(bool rot)
    {
        ...
        //desiredMovement = desiredMovement + new Vector3(camaraAnimalPropia.m_YAxis.m_InputAxisValue * 5, this.transform.rotation.y, this.transform.rotation.z);
        desiredMovement = desiredMovement * moveSpeed;

        _animator.SetFloat("velocidadBallena", desiredMovement.sqrMagnitude);
